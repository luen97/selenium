...
class RegisterNewUser(unittest.TestCase):
    ...
    def test_new_user(self):
        ...
        create_account_button = driver.find_element(by=By.XPATH,value = '/html/body/div/div[2]/div[2]/div/div/div[2]/form/div/div[1]/div[2]/a/span/span')
		#validamos que el botón esté visible y habilitado, luego damos click
        self.assertTrue(create_account_button.is_displayed() and create_account_button.is_enabled())
        create_account_button.click()
		#comprueba que estamos en el sitio de crear cuenta, verifica 
        ...
        news_letter_subscription = driver.find_element(by=By.ID, value = 'is_subscribed')
        submit_button = driver.find_element(by=By.XPATH,value = '/html/body/div/div[2]/div[2]/div/div/div[2]/form/div[2]/button')
