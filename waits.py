...
class ExplicitWaitTest(unittest.TestCase):
    ...
    #     #WebDriverWait(self.driver, 3).until(lambda s: s.find_element(by=By.ID,value='select-language').get_attribute('length') == '3')
    ...
    def test_create_new_customer(self): #Creacion de nuevo usuario
        ...
        my_account = WebDriverWait(self.driver, 5).until(EC.visibility_of_element_located((By.LINK_TEXT, 'My Account')))
        my_account.click()
        ...
        #Verificacion de estado de pagina web, titulo de la pestaña
